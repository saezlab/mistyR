...
setwd("F:/LabRotationSaez/RCode/VisiumAfterDot")
```
...
dot.srt <-setup.srt(srt_data = spatial_data@assays$Spatial@counts, srt_coords = geometry) # SCT -> scanpy transformed/ Spartial -> raw raw
...
Here is the output of `sessionInfo()` at the point wh
