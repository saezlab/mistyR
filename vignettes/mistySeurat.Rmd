...
These are helper functions that allow to extract from `r CRANpkg("Seurat")` objects specific assays and transform them into `tibble` which is a preferred format for `r Githubpkg("saezlab/mistyR")`.
