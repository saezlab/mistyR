...
#' 
#' @param from.view From view
#' @param to.view To view
#'
#' @return The \code{misty.results} list (invisibly).
#' 
#' @seealso \code{\link{collect_results()}} to generate a results list from raw 
...
#' Description
#' 
#' @param misty.results.from Results from
#' @param misty.results.to Results to
#' @param views Views vector
#' @param cutoff.from Cutoff from
#' @param cutoff.to Cutoff to
#'
#' @return The \code{misty.results} list (invisibly).
#' 
#' @seealso \code{\link{collect_results()}} to generate a results list from raw 
